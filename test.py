...
def test_add():
    ...
    #negative_numbers
    ###ERROR:assert str(EngUnit('-220mHz') + EngUnit('-10mHz'))    == '-230mHz'
    ###ERROR:assert str(EngUnit('-220mohm') + EngUnit('-220uohm')) == '-220.22mohm'
    ###ERROR:assert str(EngUnit('-220m') + EngUnit('-220n'))       == '-220m'
...
def test_sub():
    ...
    #negative_numbers
    ###ERROR:assert str(EngUnit('-220mHz') - EngUnit('-10mHz'))    == '-210mHz'
    ###ERROR:assert str(EngUnit('-220mohm') - EngUnit('-220uohm')) == '-219.78mohm'
    ###ERROR:assert str(EngUnit('-220m') - EngUnit('-220n'))       == '-220m'
